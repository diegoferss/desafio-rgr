                    ...
                    SafeArea(
                      child: UnconstrainedBox(
                        ...
                        child: ConstrainedBox(
                          constraints: BoxConstraints(maxWidth: kIsWeb ? 600 : MediaQuery.sizeOf(context).width),
                          child: Padding(
                                ...
                                Expanded(
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      Text(
                                        'Bem-vindo!',
                                        style: AppFonts.nunito(fontSize: 26, fontWeight: FontWeight.bold),
                                      ),
                                      SizedBox(height: 4),
                                      Text(
